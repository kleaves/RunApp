...
/**
 * 对RecyclerView.Adapter的扩展，用于向RecyclerView提供具有页眉和页脚的节。每个部分可以有任意数量的项。
 *
 * @param <H> 类扩展RecyclerView.ViewHolder以保存和绑定头视图
 * @param <VH> 类扩展RecyclerView.ViewHolder以保存和绑定项目视图
 * @param <F> 类扩展RecyclerView.ViewHolder以保存和绑定页脚视图
 */
